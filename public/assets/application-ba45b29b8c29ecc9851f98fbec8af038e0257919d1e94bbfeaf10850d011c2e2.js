...
function loadVillages(){
    console.log("Comming inside the loadVillages function");
    $.ajax({
        type:"GET",
        url:"/get_all_villages.json",
        success:function(villagesArray){
            var villageElement = $('#input_pgd_village_id');
            $.each(villagesArray,function(index,eachVillage){
                villageElement.append(new Option(eachVillage.name,eachVillage.id))
            });
        }
    })
}
    ...
    // New Patient Submission
        function checkAndSubmit(){
            ...
            $.ajax({
                ...
                contentType:false,
                success:function (data) {
                    showDialogueForPatientPage("New Patient Registration Successful","New Patient Registration Successful");
...
// Non-Edit Patient Template Loading
    ...
    function loadNonEditPatientPGDTemplate(patientDetails){
        ...
        $.each(patientDetails,function (eachpatientDetailKey,eachpatientDetailValue) {
            ...
            if($(eachpatientDetailInputElement).is("input")){
            ...
            }else if($(eachpatientDetailInputElement).is("input[type=file]")){
                console.log($(eachpatientDetailInputElement).attr("id")+" is a file field");
            }
        });


        // $.each(all_ids, function(key, value) {
        //     console.log("Each Patient Detail : ");
        //     console.log(key, value);
        //     if($(value).is('input[type=file]')){
        //         console.log($(value).attr('id')+" : This is an input type field");
        //     }
        //
        //     // spans.filter(function() {
        //     //     console.log("Id : "+this.id);
        //     //     return "span_pgd_"+key == this.id;
        //     // }).text(value);
        //     // console.log("==========");
        // });
